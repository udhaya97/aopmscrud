 ...
 * @Aspect
 * 
 * @Component public class DiscoveryServiceAspects {
 * 
 * 
 * DiscoveryServerAspects disSerAsp = new DiscoveryServerAspects();
 * 
 * @Pointcut("within(com.discoveryserver.checks.*)") public void mainMeth() {
 * 
 * }
 * 
 * 
 ...
 * 
 * 
 * @Around("mainMeth()") public Object disMain(ProceedingJoinPoint
 * proceedingJoinPoint) { //calling springAOP external method to print splunk
 * logs Object ob = disSerAsp.adviceMain(proceedingJoinPoint);
 * 
 * return ob;
 * 
 * }
