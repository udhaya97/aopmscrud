...
public class DepartmentAspects {
	...
	public Object AllMeth(ProceedingJoinPoint proceedingJoinPoint)
	{
		...
		try {
			...
			receiver.log("main", logArgs,"error : the "+methodName+" exception ocuurerd in department controller for this method");
			//e.printStackTrace();
		}
	...
	public Object AllMethInService(ProceedingJoinPoint proceedingJoinPoint)
	{
		...
		try {
			...
			receiver.log("main", logArgs,"the "+methodName+" exception occurerd in department service for this method");
			//e.printStackTrace();
		}
