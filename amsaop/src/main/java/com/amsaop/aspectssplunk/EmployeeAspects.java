...
public class EmployeeAspects  {
	...
	public Object AllMeth(ProceedingJoinPoint proceedingJoinPoint)
	{
		...
		try {
			...
			receiver.log("main", logArgs,"error : the "+methodName+" exception ocuurerd in employee controller for this method");
			//e.printStackTrace();
		}
	...
	public Object AllMethInService(ProceedingJoinPoint proceedingJoinPoint)
	{
		...
		try {
			...
			receiver.log("main", logArgs,"error : the "+methodName+" exception ocuurerd in employee service for this method");
			//e.printStackTrace();
		}
	...
	public Object AllMethInDao(ProceedingJoinPoint proceedingJoinPoint)
	{
		...
		try {
			...
			receiver.log("main", logArgs,"error : the "+methodName+" exception ocuurerd in employee dao for this method");
			//e.printStackTrace();
		}
